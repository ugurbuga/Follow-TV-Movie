...
@AndroidEntryPoint
class ContinuedTvShowListFragment : FavoriteListFragment() {

    private val sharedViewModel: TvShowsViewModel by viewModels({ requireParentFragment() })

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        viewModel.setFavoriteListType(MediaType.TV, FavoriteListType.WATCH_LATER_LIST)
    }
    ...
    companion object {
        fun newInstance() = ContinuedTvShowListFragment()
    }
}